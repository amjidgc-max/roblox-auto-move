-- LocalScript, StarterPlayerScripts içinde varsayılıyor
...
-- Script durumları
local autoMoveEnabled = true -- otomatik başlasın
...
toggleButton.Size = UDim2.new(0.6,0,0,50)
...
-- ==== HURRY BUTTON (GET FAST) ====
local hurryButton = Instance.new("TextButton")
hurryButton.Size = UDim2.new(0.35,0,0,50)
...
local function performWalk(directionSign)
	...
	targetPart.Name = "AutoMoveTarget"
...
local dragPoint = Instance.new("Frame") -- sağ üst beyaz nokta
dragPoint.Size = UDim2.new(0,15,0,15)
dragPoint.Position = UDim2.new(1,-20,0,5)
